...
|housing_median_age | numeric | median age of a house within a block; a lower number is a newer building |
...
|median_income | numeric | median income for households within a block of houses (measured in tens of thousands of US Dollars) |
|median_house_value | numeric | median house value for households within a block (measured in US Dollars) |
|ocean_proximity | categorical | location of the house with respect to the ocean |
...
knitr::include_graphics('images/1-2-ocean_proximity.jpg')
```
...
```{r 1-2-correlation-matrix, fig.align="center",out.width="500", echo=FALSE, fig.cap='Correlation matrix'}
...
```{r 1-2-map, fig.align="center", echo=FALSE, fig.cap='Map of all houses (left) and of houses worth more than $490.000'}
knitr::include_graphics('images/1-2-map.png')
```
...
```{r latlong-map, fig.align="center", out.width = "70%", echo=FALSE, fig.cap='Map of California'}
