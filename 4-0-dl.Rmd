...
People started to verify the reproducibility of the papers also to check whether the results in the paper are trustworthy. It happens that the authors do “cherry-picking” of the results.
...
In this chapters, students focused on the reproducibility of Deep Learning papers [@4-reproducibility]. It was motivated by two facts featuring models in Deep Learning:
...
These two points show that the task of reproducibility in Deep Learning can be sometimes a challenge. 
