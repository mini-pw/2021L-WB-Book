...
Unfortunately, with given requirements, the provided code faces critical issues, not allowing it to properly execute, forcing us into the inquiry, that has resulted in reconsideration of few packages.
Namely in order for code to execute, we :  
* changed the tensorflow version from 1.12.0 to 1.13.1
...
![Original Precission-Recall](images/4-2-precission-recall-original)  
And now with our results:  
![Results Precission-Recall](images/4-2-precission-recall-results)  
