...
```{r 2-3-distributions, out.width='2400', fig.align='center', echo=FALSE, fig.cap='Distributions of explanatory variables (histogram)'}
...
```{r 2-3-correlations, out.width='2400', fig.align='center', echo=FALSE, fig.cap='Correlations of explanatory variables (correlation matrix)'}
...
```{r 2-3-roc, out.width='2400', fig.align='center', echo=FALSE, fig.cap='ROC curve and corresponding AUC for the final model'}
...
```{r 2-3-pr, out.width='2400', fig.align='center', echo=FALSE, fig.cap='PR curve and corresponding AUC for the final model'}
...
Global explanations [@2-3-xai] are used to discover how individual explanatory variables affect an average model prediction on the level of the whole dataset. Here, one can learn how strong is the influence of a given variable or how its particular values shape the overall model response.
...
```{r 2-3-permutation, out.width='2400', fig.align='center', echo=FALSE, fig.cap='Permutation Feature Importance Profile'}
...
```{r 2-3-pdp, out.width='2400', fig.align='center', echo=FALSE, fig.cap='Partial Dependence Profile'}
...
```{r 2-3-ale, out.width='2400', fig.align='center', echo=FALSE, fig.cap='Accumulated Local Effect Profile'}
...
```{r 2-3-ceteris1, out.width='2400', fig.align='center', echo=FALSE, fig.cap='Ceteris Paribus Profile for observation number 342'}
...
```{r 2-3-ceteris2, out.width='2400', fig.align='center', echo=FALSE, fig.cap='Ceteris Paribus Profile for observation number 16'}
...
```{r 2-3-break1, out.width='2400', fig.align='center', echo=FALSE, fig.cap='Break Down Profile for observation number 4'}
...
```{r 2-3-break2, out.width='2400', fig.align='center', echo=FALSE, fig.cap='Break Down Profile for observation number 109.'}
