...
```{r ConfMatrix, out.height="250", fig.align="center", echo=FALSE, fig.cap='Confusion matrix for base model '}
...
```{r Smallchanges, out.height="250", fig.align="center", echo=FALSE, fig.cap='Confusion matrix for model with small changes'}
...
```{r L1L2, out.height="250", fig.align="center", echo=FALSE, fig.cap='Confusion matrix for model with L1, model with L2 and model with both'}
...
```{r WihoutDropout, out.height="250", fig.align="center", echo=FALSE, fig.cap='Confusion matrix for model without dropout'}
...
```{r CM1, out.height="250", fig.align="center", echo=FALSE, fig.cap='Confusion matrix for model with branching in dense layers'}
...
```{r CM2, out.height="250", fig.align="center", echo=FALSE, fig.cap='Confusion matrix for model with class weights mechanism'}
...
```{r CM3, out.height="250", fig.align="center", echo=FALSE, fig.cap='Confusion matrix for model with separated first convolutional block'}
...
```{r Ensemble2, out.height="250", fig.align="center", echo=FALSE, fig.cap='Ensemble of multiple VGG'}
...
```{r Transfer, out.height="250", fig.align="center", echo=FALSE, fig.cap='Transfer learning results'}
