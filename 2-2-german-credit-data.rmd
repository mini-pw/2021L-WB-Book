...
First of all, we began with Feature Importance method [@2-2-biecek2021explanatory] which gives information on the importance of features in the model. The results of applying this method on our model can be seen in the figure below.  
