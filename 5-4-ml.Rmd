...
* replication of the architecture proposed by [@li_et_al_2020] (referred to as the *Baseline* model),
...
Neural network models were created using Keras Python library [@tensorflow_2015].
...
SHAP values were calculated for the xgboost models using the R `treeshap` library [@treeshap_2020]. 
...
```{r fig3, out.width="50%", message=FALSE, fig.align='center', echo=FALSE, fig.cap="each boxplot represents 25 independent model tests. Neural network model names explained: *Baseline* -  a replication of the model from [@li_et_al_2020] article, *Basic* - basic model using two hidden layers of 32 neurons each with binary cross entropy as the loss function, *Modified* - modified version of the article model using binary cross entropy as the loss function."}
include_graphics(path = "images/5-4-icu_nn.png")
```

```{r fig4, out.width="50%", message=FALSE, fig.align='center', echo=FALSE, fig.cap="each boxplot represents 25 independent model tests. Neural network model names explained: *Baseline* -  a replication of the model from [@li_et_al_2020] article, *Basic* - basic model using two hidden layers of 32 neurons each with binary cross entropy as the loss function, *Modified* - modified version of the article model using binary cross entropy as the loss function."}
