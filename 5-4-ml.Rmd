...
* replication of the architecture proposed by [@5-4-li-et-al] (referred to as the *Article* model),
...
SHAP values were calculated for the xgboost models using r `treeshap` library [@5-4-treeshap]. 
